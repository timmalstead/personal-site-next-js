            ...
            content: {
                data: {
                    metadata: {
                        ...
                        description:
                            "Blog entry detailing my process for setting up a small home server on an ubuntu server instance",
                        openGraph: {
                            description:
                                "Blog entry detailing my process for setting up a small home server on an ubuntu server instance",
                            locale: "en_US",
                            title: "How I Set Up My Home Server",
                            type: "website",
                            url: "https://www.timothymalstead.com/blog/how-i-set-up-my-home-server",
                        },
                    },
                    components: [
                        {
